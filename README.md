...
- A semantic-version tag such as `v2.4.23`
...
For the current `2.4.23 / build 43` package, the verified ZIP SHA-256 is:

```text
3b0fb052526b1eb7a996fc962e82c9e1ddfeb337764806ff4436d657d9f432e8
```
