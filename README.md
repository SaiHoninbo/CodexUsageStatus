...
- A semantic-version tag such as `v2.4.20`
...
For the current `2.4.20 / build 40` package, the verified ZIP SHA-256 is:

```text
df71034126c77f9e96b6cec5d49b8259106ed78bb1239898f4d5510e2a39f331
```
