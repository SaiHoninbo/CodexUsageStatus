...
- A semantic-version tag such as `v2.4.25`
...
For the current `2.4.25 / build 45` package, the verified ZIP SHA-256 is:

```text
4f8c15971858cd0b2605a39efd80ab7e89b4086a34328d9b59727eeb31c80c36
```
